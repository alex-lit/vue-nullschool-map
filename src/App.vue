<script lang="ts">
  ...
  import VueNullscoolMap from '@/components/vue-nullscool-map';
  import WrapperDemo from '@/components/wrapper-demo';

  @Component<App>({
    components: { VueGithubCorners, VueNullscoolMap, WrapperDemo },
  })
...
<template>
  <main class="app">
    ...
    <section class="app__container">
      <wrapper-demo>
        <vue-nullscool-map></vue-nullscool-map>
        ...
        <template #config>
          <el-form size="mini" label-position="top">
            ...
            <!-- counter -->
            <el-form-item
              label="Признак того, что на кнопке соцсети отображается счетчик публикаций"
            >
